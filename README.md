...
Durante a live aprendemos a construção do tópico de testes que é considerado essencial para qualquer desenvolvimento de aplicações, além disso, essencial 
para o desenvolvimento da carreira. A ideia dessa API é gerenciar a construção de heróis da Marvel 
e da DC não podendo haver heróis com o mesmo nome.
...
```
http://localhost:8080/api/v1/heros
```
